...
public class ExtentTestMap extends BasicMap {
    ...
    private OLPoint[] GRAcoordinateList;
...
//                new OLPoint(12.380218505365, 41.885921026773) };
        ...
        // ROME GRA "EPSG:3857"
        GRAcoordinateList = new OLPoint[] {
                new OLPoint(1389679.0894, 5145161.7486),
                new OLPoint(1392621.9150, 5159340.8173),
                new OLPoint(1404354.9988, 5147454.8594),
                new OLPoint(1393042.3187, 5130103.6540),
                new OLPoint(1377219.8538, 5140651.9639) };
